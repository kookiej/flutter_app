        ...
        children: [
          LayoutBuilder(
            builder: (context, constraints) {
              double _calc(double dx) =>
                  (dx / constraints.maxWidth * widget.song.duration)
                      .clamp(0.0, widget.song.duration.toDouble());
              return GestureDetector(
                onHorizontalDragStart: (d) => setState(() {
                  _dragging = true;
                  _dragValue = _calc(d.localPosition.dx);
                }),
                ...
                onTapDown: (d) => widget.onSeek(_calc(d.localPosition.dx)),
                child: SizedBox(
                  height: 44,
                  child: Stack(
